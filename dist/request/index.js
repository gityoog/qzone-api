...
var QzoneApiRequest = /** @class */ (function () {
    function QzoneApiRequest() {
        this.axios = axios_1.default.create({
            maxRedirects: 0,
            validateStatus: function (status) { return status >= 200 && status < 303; }
        });
        this.init();
    }
    QzoneApiRequest.prototype.init = function () {
        var _this = this;
        this.axios.interceptors.request.use(function (req) {
            req.headers = req.headers || {};
            req.headers['Cookie'] = _this.cookie.all();
            return req;
        });
        this.axios.interceptors.response.use(function (res) {
            if (res.headers["set-cookie"]) {
                _this.cookie.add(res.headers["set-cookie"]);
            }
            return res;
        });
    };
    QzoneApiRequest.prototype.get = function (url) {
    ...
    QzoneApiRequest.prototype.jsonp = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    QzoneApiRequest.prototype.destroy = function () {
        this.axios = null;
    };
    __decorate([
        (0, ioc_di_1.Inject)(),
    ...
    ], QzoneApiRequest.prototype, "init", null);
    __decorate([
        ioc_di_1.Destroy,
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
...
exports.default = QzoneApiRequest;
